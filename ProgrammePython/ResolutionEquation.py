...
from MethodeDeResolution import methode_de_dichotomie, methode_de_la_secante, methode_de_newton_raphson, methode_du_point_fixe, methode_de_balayage
...
def main():
    ...
    while action:
        ...
        if choix == 1:
            ...
            # Exécution de la méthode de balayage
